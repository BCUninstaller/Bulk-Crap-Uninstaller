    ...
    internal static class Hresult
    {
        public static string ConvertHresultToDetails(int errorCode)
        {
            switch ((uint)errorCode)
            {
                ...
                case 0x240007: return "WU_S_ALREADY_UNINSTALLED - The update to be !(removed is installed on) the system.";
                ...
                case 0x80240041: return "WU_E_SYSPREP_IN_PROGRESS - !(Service is available while) sysprep is running.";
                ...
                case 0x80248005: return "WU_E_DS_INVALIDTABLENAME - A table could not be opened because the !(table is in the) data store.";
                case 0x80248006: return "WU_E_DS_BADVERSION - The current and expected versions of the data store do not match.";
                case 0x80248007: return "WU_E_DS_NODATA - The information !(requested is in the) data store.";
                ...
                case 0x8024800D: return "WU_E_DS_NOCATEGORIES - The category was not added because it contains no parent categories !(and is a top)-level category itself.";
                ...
                case 0x80248010: return "WU_E_DS_CANNOTREGISTER - The data !(store is allowed to) be registered with COM in the current process.";
                ...
                case 0x80248014: return "WU_E_DS_UNKNOWNSERVICE - An operation did not complete because the !(service is in the) data store.";
                ...
                case 0x80248017: return "WU_E_DS_TABLESESSIONMISMATCH - A table was not closed because !(it is associated with) the session.";
                case 0x80248018: return "WU_E_DS_SESSIONLOCKMISMATCH - A table was not closed because !(it is associated with) the session.";
