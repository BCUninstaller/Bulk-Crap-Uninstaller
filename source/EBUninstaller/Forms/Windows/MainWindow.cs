    ...
    internal sealed partial class MainWindow : Form
    {
        ...
        private void InitializeProNavigationAndTools()
        {
            try
            {
                ...
                menuCleaners.DropDownItems.Add(new ToolStripMenuItem("Windows Firewall Orphaned Rules Cleaner...", null, (s, e) => OpenFirewallOrphanCleaner()));
                menuCleaners.DropDownItems.Add(new ToolStripMenuItem("Shell Icon & Thumbnail Database Rebuilder...", null, (s, e) => OpenIconThumbnailRebuilder()));
                menuCleaners.DropDownItems.Add(new ToolStripMenuItem("DCOM & Component Services Orphan Cleaner...", null, (s, e) => OpenDcomOrphanCleaner()));
                menuCleaners.DropDownItems.Add(new ToolStripMenuItem("Windows Print Spooler Residuals Cleaner...", null, (s, e) => OpenPrintSpoolerCleaner()));
                menuCleaners.DropDownItems.Add(new ToolStripMenuItem("Software Environment Variables Residuals Cleaner...", null, (s, e) => OpenEnvVarResidualsCleaner()));
                ...
                menuWinManagement.DropDownItems.Add(new ToolStripMenuItem("Windows Exploit Guard & Process Mitigation Auditor...", null, (s, e) => OpenExploitGuardAuditor()));
                menuWinManagement.DropDownItems.Add(new ToolStripMenuItem("Scheduled Tasks Orphan & Residuals Cleaner...", null, (s, e) => OpenScheduledTaskOrphanCleaner()));
                menuWinManagement.DropDownItems.Add(new ToolStripMenuItem("Virtual Network Adapters & VPN TAP/TUN Auditor...", null, (s, e) => OpenVirtualAdapterAuditor()));
                ...
                if (toolsToolStripMenuItem != null)
                {
                    ...
                    tmCleaners.DropDownItems.Add(new ToolStripMenuItem("Windows Firewall Orphaned Rules Cleaner...", null, (s, e) => OpenFirewallOrphanCleaner()));
                    tmCleaners.DropDownItems.Add(new ToolStripMenuItem("Shell Icon & Thumbnail Database Rebuilder...", null, (s, e) => OpenIconThumbnailRebuilder()));
                    tmCleaners.DropDownItems.Add(new ToolStripMenuItem("DCOM & Component Services Orphan Cleaner...", null, (s, e) => OpenDcomOrphanCleaner()));
                    tmCleaners.DropDownItems.Add(new ToolStripMenuItem("Windows Print Spooler Residuals Cleaner...", null, (s, e) => OpenPrintSpoolerCleaner()));
                    tmCleaners.DropDownItems.Add(new ToolStripMenuItem("Software Environment Variables Residuals Cleaner...", null, (s, e) => OpenEnvVarResidualsCleaner()));
                    ...
                    tmWinManagement.DropDownItems.Add(new ToolStripMenuItem("Windows Exploit Guard & Process Mitigation Auditor...", null, (s, e) => OpenExploitGuardAuditor()));
                    tmWinManagement.DropDownItems.Add(new ToolStripMenuItem("Scheduled Tasks Orphan & Residuals Cleaner...", null, (s, e) => OpenScheduledTaskOrphanCleaner()));
                    tmWinManagement.DropDownItems.Add(new ToolStripMenuItem("Virtual Network Adapters & VPN TAP/TUN Auditor...", null, (s, e) => OpenVirtualAdapterAuditor()));
        ...
        private void OpenSoftwareCrashHistory()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.SoftwareCrashHistoryWindow();
            dlg.ShowDialog(this);
        }

        private void OpenServiceConflictDetector()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.ServiceConflictDetectorWindow();
            dlg.ShowDialog(this);
        }

        private void OpenPathEnvironmentAuditor()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.PathEnvironmentAuditorWindow();
            dlg.ShowDialog(this);
        }
        ...
        private void OpenAppContainerAuditor()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.AppContainerAuditorWindow();
            dlg.ShowDialog(this);
        }

        private void OpenExploitGuardAuditor()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.ExploitGuardAuditorWindow();
            dlg.ShowDialog(this);
        }

        private void OpenFirewallOrphanCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.FirewallOrphanCleanerWindow();
            dlg.ShowDialog(this);
        }

        private void OpenIconThumbnailRebuilder()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.IconThumbnailRebuilderWindow();
            dlg.ShowDialog(this);
        }

        private void OpenDcomOrphanCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.DcomOrphanCleanerWindow();
            dlg.ShowDialog(this);
        }

        private void OpenPrintSpoolerCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.PrintSpoolerCleanerWindow();
            dlg.ShowDialog(this);
        }

        private void OpenSocketHealthAuditor()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.SocketHealthAuditorWindow();
            dlg.ShowDialog(this);
        }

        private void OpenEnvVarResidualsCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.EnvVarResidualsCleanerWindow();
            dlg.ShowDialog(this);
        }

        private void OpenAuthenticodeAuditor()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.AuthenticodeIntegrityAuditorWindow();
            dlg.ShowDialog(this);
        }

        private void OpenKernelLiveDumpCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.KernelLiveDumpCleanerWindow();
            dlg.ShowDialog(this);
        }

        private void OpenDeliveryOptimizationCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.DeliveryOptimizationCleanerWindow();
            dlg.ShowDialog(this);
        }

        private void OpenScheduledTaskOrphanCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.ScheduledTaskOrphanCleanerWindow();
            dlg.ShowDialog(this);
        }

        private void OpenFontCacheCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.FontCacheCleanerWindow();
            dlg.ShowDialog(this);
        }

        private void OpenVirtualAdapterAuditor()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.VirtualAdapterAuditorWindow();
            dlg.ShowDialog(this);
        }

        private void OpenBitsQueueCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.BitsQueueCleanerWindow();
            dlg.ShowDialog(this);
        }
        ...
        private void OpenUsbDriverCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.UsbDriverCleanerWindow();
            dlg.ShowDialog(this);
        }

        private void OpenCngProviderAuditor()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.CngProviderAuditorWindow();
            dlg.ShowDialog(this);
        }

        private void OpenWinsockNamespaceCleaner()
        {
            using var dlg = new BulkCrapUninstaller.Forms.Windows.WinsockNamespaceCleanerWindow();
            dlg.ShowDialog(this);
        }
