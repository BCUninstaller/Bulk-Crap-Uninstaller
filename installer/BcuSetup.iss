...
Type: files; Name: "{app}\RatingCashe_Avg.json"
Type: files; Name: "{app}\RatingCashe_User.json"
Type: files; Name: "{app}\RatingCashe_Pending.json"
Type: files; Name: "{app}\win-x64\*.log"
Type: files; Name: "{app}\win-x64\Exception_*.zip"
Type: files; Name: "{app}\win-x64\InfoCache.xml"
Type: files; Name: "{app}\win-x64\CertCache.xml"
Type: files; Name: "{app}\win-x64\UsageStatistics.xml"
Type: files; Name: "{app}\win-x64\RatingCashe_Avg.json"
Type: files; Name: "{app}\win-x64\RatingCashe_User.json"
Type: files; Name: "{app}\win-x64\RatingCashe_Pending.json"
Type: files; Name: "{app}\win-x86\*.log"
Type: files; Name: "{app}\win-x86\Exception_*.zip"
Type: files; Name: "{app}\win-x86\InfoCache.xml"
Type: files; Name: "{app}\win-x86\CertCache.xml"
Type: files; Name: "{app}\win-x86\UsageStatistics.xml"
Type: files; Name: "{app}\win-x86\RatingCashe_Avg.json"
Type: files; Name: "{app}\win-x86\RatingCashe_User.json"
Type: files; Name: "{app}\win-x86\RatingCashe_Pending.json"
